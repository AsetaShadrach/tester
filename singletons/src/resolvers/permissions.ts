...
import { Permission, TestAccount } from "project_orms/dist/entities/singeltons";
...
export class PermissionsResolver{
    ...
    async createPermission(
        ...
        {
        return await this.permissionService.createPermission(permissionCreationInput);      
    }
    ...
    async updatePermission(
        ...
        {
        return await this.permissionService.updatePermission(permissionId,permissionUpdateInput);      
    }    
}
